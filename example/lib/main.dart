...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Widget> sides = [
    const SlideContainer(label: '1', color: Colors.indigo),
    SlideContainer(color: Colors.green[500]!, label: '2'),
    SlideContainer(color: Colors.orange[500]!, label: '3'),
    SlideContainer(color: Colors.blue[500]!, label: '4'),
    SlideContainer(color: Colors.pink[400]!, label: '5'),
    const SlideContainer(color: Colors.purple, label: '6')
  ];
